                  ...
                  <div className="overflow-hidden">
                    <table className="min-w-full divide-y divide-gray-200">
                        ...
                        return (
                          <tbody key={uindex} className="divide-y divide-gray-200">
                            <tr className="border-neutral-500 border-t-2">
                              ...
                              {user.roles?.map((o) => o.role).join(', ')}</td>
                              <td className="px-6 py-1 whitespace-nowrap text-end text-sm font-medium">
                      ...
                      <tfoot>
                        <tr>
                          <td className="px-1 py-1">
                            <input type="text" ref={filterUserRef} name="filterUsers" placeholder="Filter users by name" className="px-2 py-1 text-sm border border-gray-300 rounded-lg" />
